...
class EditroWithClear extends Editor {
    constructor(implementor){
        super(implementor);
    }
...
class CanvasPainter {
    ...
    print() {
        this.ctx.cleatRect(0,0,this.canvas.width,this.canvas.height);
...
//const editor = new EditroWithClear(new HTMLPainter(content));
const editor = new EditroWithClear(new CanvasPainter(canvas));
